...
- [`README.md`](workflow/README.md) — жизненный цикл задачи (семейство `workflow`), обзор.
- [`skills.md`](workflow/skills.md) — справочник по 12 скиллам: режим, задача, механика.
